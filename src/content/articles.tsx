...
export default [
  {
    title: 'Covid-19 Facts #1',
    source: 'Covid-19 Facts #1',
    link: 'https://drive.google.com/file/d/1wJlGcunbVZvp2L3YTCjcgw9Yuq1D5bkd/view?usp=sharing',
    categories: [DIGITAL_CONTENT],
    imagePath: '/assets/covid-facts-1.jpg',
  },
  {
    title: 'Covid-19 Facts #2',
    source: 'Covid-19 Facts #2',
    link: 'https://drive.google.com/file/d/1qsrDvRYFvyB9FE1qKwOlIaItsR6icIfA/view?usp=sharing',
    categories: [DIGITAL_CONTENT],
    imagePath: '/assets/covid-facts-2.jpg',
  },
  {
    title: 'Covid-19 Facts #3',
    source: 'Covid-19 Facts #3',
    link: 'https://drive.google.com/file/d/19raXSAmYYV9XWECqTbU771uwrH1qVIZW/view?usp=sharing',
    categories: [DIGITAL_CONTENT],
    imagePath: '/assets/covid-facts-3.jpg',
  },
  {
    title: 'Covid-19 Facts #4',
    source: 'Covid-19 Facts #4',
    link: 'https://drive.google.com/file/d/1K41Oq9ZFSLwFGFwqpGqlItNObEICZdmh/view?usp=sharing',
    categories: [DIGITAL_CONTENT],
    imagePath: '/assets/covid-facts-4.jpg',
  },
  {
    title: 'Covid-19 Facts #5',
    source: 'Covid-19 Facts #5',
    link: 'https://drive.google.com/file/d/1K41Oq9ZFSLwFGFwqpGqlItNObEICZdmh/view?usp=sharing',
    categories: [DIGITAL_CONTENT],
    imagePath: '/assets/covid-facts-5.jpg',
  },
  {
    title: 'Why You Should Trust The Covid-19 Vaccine Flyer',
    source: 'Why You Should Trust The Covid-19 Vaccine Flyer',
    link: 'https://drive.google.com/file/d/1iMWM8BojinnLC5uKKvhU4sEyDzwTRppe/view?usp=sharing',
    categories: [DIGITAL_CONTENT],
    imagePath: '/assets/COVID-19-Vaccine-Facts-Flyer.jpg',
  },
  {
    title: 'National Breastfeeding Month Promo Flyer',
    source: 'National Breastfeeding Month Promo Flyer',
    link: 'https://drive.google.com/file/d/1f9MgEl2qiTCru1nehVtODZz_pNu6DBT_/view?usp=sharing',
    highlight: 'Need Breastfeeding Help for the First Year?',
    preview: 'Most WIC clinics have breastfeeding Peer Counselors who can help with basic breastfeeding issues, and International Board Certied Lactation Consultants to help with more dicult problems. During the month of August Your Public Health Department will be celebrating National Breastfeeding Awareness Month with family-friendly events designed to educate and enjoy.',
    publicationDate: '',
    publicationLogo: null,
    categories: [DIGITAL_CONTENT],
  },
  {
    title: 'National Breastfeeding Month Promo Flyer (Spanish)',
    source: 'National Breastfeeding Month Promo Flyer (Spanish)',
    link: 'https://drive.google.com/file/d/1siDZpSi7_896lnjnXJjlmUPStU2TE58w/view?usp=sharing',
    highlight: 'Need Breastfeeding Help for the First Year?',
    preview: 'Most WIC clinics have breastfeeding Peer Counselors who can help with basic breastfeeding issues, and International Board Certied Lactation Consultants to help with more dicult problems. During the month of August Your Public Health Department will be celebrating National Breastfeeding Awareness Month with family-friendly events designed to educate and enjoy.',
    publicationDate: '',
    publicationLogo: null,
